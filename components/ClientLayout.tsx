      ...
      <aside style={{ width: '210px', minWidth: '210px', background: '#070D07', borderRight: '1px solid #1A2A1A', display: 'flex', flexDirection: 'column', height: '100vh', overflow: 'hidden' }}>
        ...
        <div style={{ padding: '12px 14px', borderTop: '1px solid #1A2A1A', flexShrink: 0 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '7px' }}>
            ...
            <span style={{ fontFamily: 'Syne, sans-serif', fontSize: '9px', color: '#2A5A2A', letterSpacing: '1px' }}>{stats ? `${stats.total_incidents} CRITICOS ACTIVOS` : 'CARGANDO...'}</span>
          </div>
          <div style={{ marginTop: '8px', fontSize: '8px', color: '#1A3A1A', fontFamily: 'Syne, sans-serif', letterSpacing: '1px' }}>v1.0.0 · Daniel González</div>
        </div>
      </aside>
